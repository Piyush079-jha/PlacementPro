...
import { Shield, AlertTriangle, CheckCircle, XCircle, Zap, Search, Lock } from 'lucide-react';
...
const VERDICT_CONFIG = {
  Genuine:    { color: '#22c55e', bg: 'rgba(34,197,94,0.08)',  border: 'rgba(34,197,94,0.2)',  badge: '#166534', label: 'Genuine Job',       emoji: '✅' },
  Suspicious: { color: '#f59e0b', bg: 'rgba(245,158,11,0.08)', border: 'rgba(245,158,11,0.2)', badge: '#78350f', label: 'Suspicious Posting', emoji: '⚠️' },
  Fake:       { color: '#ef4444', bg: 'rgba(239,68,68,0.08)',  border: 'rgba(239,68,68,0.2)',  badge: '#7f1d1d', label: 'Likely a Scam',      emoji: '🚫' },
};
...
export default function FakeDetector() {
  ...
  return (
    <div style={{ maxWidth: 780, margin: '0 auto', padding: '8px 0 48px' }} className="space-y-6 animate-fade-in">
      ...
      {/* Input card */}
      <div className="card" style={{ padding: 24, space: 0 }}>
        ...
        <textarea
          ...
          placeholder={`Paste the job posting text here...\n\nOr paste a URL: https://linkedin.com/jobs/view/...`}
          value={input}
              ...
              <div className="card" style={{ border: '1px solid rgba(239,68,68,0.12)', padding: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
                  ...
                  <span style={{
                    ...
                    color: '#ef4444', borderRadius: 99, padding: '1px 8px', fontSize: 12, fontWeight: 600
              ...
              <div className="card" style={{ border: '1px solid rgba(34,197,94,0.12)', padding: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
                  ...
                  <span style={{
                    ...
                    color: '#22c55e', borderRadius: 99, padding: '1px 8px', fontSize: 12, fontWeight: 600
